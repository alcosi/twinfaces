  ...
  function search({
    ...
    return settings.client.POST("/private/factory_condition/search/v1", {
      params: {
        ...
        query: {
          lazyRelation: false,
          showConditionSetInFactoryBranchUsagesCountMode: "HIDE",
          showConditionSetInFactoryEraserUsagesCountMode: "HIDE",
          showConditionSetInFactoryMultiplierFilterUsagesCountMode: "HIDE",
          showConditionSetInFactoryPipelineStepUsagesCountMode: "HIDE",
          showConditionSetInFactoryPipelineUsagesCountMode: "HIDE",
          ...
          showFactoryConditionSet2UserMode: "HIDE",
          showUser2UserGroupMode: "HIDE",
