...
export function createTwinClassApi(settings: ApiSettings) {
    ...
    return settings.client.POST("/private/twin_class/search/v2", {
      params: {
        ...
        query: {
          ...
          showTwinClassMarker2DataListMode: "DETAILED",
          showTwinClassTag2DataListMode: "DETAILED",
  ...
  function searchDynamicMarkers({
    ...
    return settings.client.POST(
      "/private/twin_class_dynamic_marker/search/v1",
      {
        params: {
          header: getApiDomainHeaders(settings),
          query: {
