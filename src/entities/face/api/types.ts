...
export type FaceTC002 = components["schemas"]["FaceTC002v1"];
...
export type FaceTC002ViewRs = components["schemas"]["FaceTC002ViewRsV1"];

export type FaceTCComponent = "TC001" | "TC002";
export type FaceTCViewMap = {
  TC001: FaceTC001ViewRs;
  TC002: FaceTC002ViewRs;
};
export type FaceTCComponentSchemaMap = {
  TC001: FaceTC001;
  TC002: FaceTC002;
};
