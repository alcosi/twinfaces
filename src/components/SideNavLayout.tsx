...
export function SideNavLayout({sections, defaultSectionKey, children, returnOptions}: SideNavLayoutProps) {
    ...
    useEffect(() => {
        ...
        if (defaultSectionKey) {
            const section = sections.find((section) => section.key === defaultSectionKey);
    ...
    return <div className="mx-auto w-full flex md:flex-row flex-col gap-4">
        <nav
