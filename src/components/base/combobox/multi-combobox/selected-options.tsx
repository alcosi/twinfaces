        ...
        ? (
            <div className="flex flex-wrap items-center w-full">
                ...
                {selected.length > MAX_COUNT && (
                    <Badge
                        className="mr-2 bg-transparent text-foreground border-foreground/10 hover:bg-card m-1 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
                    >
