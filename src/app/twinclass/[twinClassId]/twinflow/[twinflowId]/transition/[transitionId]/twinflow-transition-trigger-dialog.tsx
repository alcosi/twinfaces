import {TwinFlowTransition, TwinFlowTransitionTrigger, TwinFlowTransitionTriggerUpdate} from "@/lib/api/api-types";
...
export function TwinflowTransitionTriggerDialog({
    ...
    async function createUpdateTrigger(newTrigger: TwinFlowTransitionTriggerUpdate) {
        try {
    ...
    return <AutoDialog
        settings={triggerAutoDialogSettings}
        {...props}
    />
}