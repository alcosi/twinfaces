...
const twinFlowTransitionSchema = z.object({
    ...
    description: z.string().min(0).max(100).optional().or(z.literal('').transform(() => undefined)),
        ...
        <DialogContent className="sm:max-w-md overflow-y-scroll max-h-[100%] sm:max-h-[80%]">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <TextFormField control={form.control} name="alias" label="Alias" required={true}
                                   idPrefix="create-edit-transition" suggestions={existingAliases}/>
