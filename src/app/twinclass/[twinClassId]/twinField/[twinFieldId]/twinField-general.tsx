...
export function TwinFieldGeneral({field, onChange}: {
    ...
    const nameAutoDialogSettings: AutoEditDialogSettings = {
        ...
        title: 'Update name',
        onSubmit: (values) => {
            return updateField({nameI18n: {translationInCurrentLocale: values.name}})
        },
        valuesInfo: {
            "name": {
    ...
    const descriptionAutoDialogSettings: AutoEditDialogSettings = {
        ...
        onSubmit: (values) => {
            return updateField({descriptionI18n: {translationInCurrentLocale: values.description}})
        },
        valuesInfo: {
            "description": {
