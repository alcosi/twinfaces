...
export const TwinContext = createContext<TwinContextProps>({} as TwinContextProps);

export function TwinContextProvider({twinId, children}: { twinId: string, children: React.ReactNode }) {
    ...
    return <TwinContext.Provider value={{
        twinId,
        twin,
        fetchTwinData,
    }}>
