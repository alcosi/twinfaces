...
import { CAN_USE_DOM } from "../libs/can-use-dom";
import { $isInlineImageNode } from "../libs/is-inline-image-node";
import {
...
export function InsertInlineImageDialog({
  ...
  return (
    <div className="grid gap-4 px-6 py-4">
      ...
      <DialogFooter showSeparator={false}>
        <Button
