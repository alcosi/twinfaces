  ...
  return (
    <BaseSvgIcon className={className} viewBox="0 0 24 24" {...props}>
      <g>
        <path
          fill="none"
          strokeWidth={props.strokeWidth ? 3 : 2}
        ...
        />
        <path strokeWidth={props.strokeWidth ? 3 : 2} d="M12 21V12"></path>{" "}
        <path strokeWidth={props.strokeWidth ? 3 : 2} d="M12 12L4 7.5"></path>{" "}
        <path strokeWidth={props.strokeWidth ? 3 : 2} d="M20 7.5L12 12"></path>{" "}
      </g>
    </BaseSvgIcon>
  );
}
