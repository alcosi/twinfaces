...
>(({ className, onClick, onPointerDown, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-30 bg-black/60 backdrop-blur-sm",
      className
    )}
    onClick={(event) => {
...
function DialogHeader({
  ...
  return (
    <div
      className={cn(
        "border-border rounded-t-2xl border-b",
