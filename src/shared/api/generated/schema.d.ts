...
export interface paths {
  ...
  "/public/data_list_option/map/v1": {
    /** Returns map options id ref list data options */
  ...
  "/private/data_list_option/search/v1": {
    /** Return a list of all data list options for the current domain */
...
export interface components {
  schemas: {
    ...
    TwinClassFieldDescriptorListLongV1: {
      ...
      fieldType?: string;
      /**
       * @description Can custom options be entered
       * @example false
       */
    ...
    RelatedObjectsV1: {
      ...
      /**
       * @description related options map
       * @example {options map}
       */
      dataListsOptionMap?: {
        [key: string]: components["schemas"]["DataListOptionV1"];
    ...
    DataListOptionSearchRqV1: {
      ...
      /** @description options like list */
      optionLikeList?: string[];
      /** @description options not like list */
      optionNotLikeList?: string[];
      /** @description options i18n like list */
      optionI18nLikeList?: string[];
      /** @description options i18n not like list */
    ...
    DataListOptionMapRqV1: {
      /**
       * @description data list options id set
       * @example [
    ...
    DataListOptionMapRsV1: {
       ...
       */
      statusDetails?: string;
      /** @description map { data list options id / data list options } */
      dataListOptionMap?: {
        [key: string]: components["schemas"]["DataListOptionV1"];
      };
    };
    /** @description data list options search */
...
export interface operations {
  ...
  dataListOptionsMapViewPublicV1: {
    ...
    responses: {
      /** @description Map {options id/list data options} prepared */
      200: {
        content: {
  ...
  factoryPipelineStepSearchV1: {
    parameters: {
      query?: {
        ...
        showFactoryPipelineStep2FactoryPipeline?: "HIDE" | "SHORT" | "DETAILED";
